...
<body class="container mt-5">
    ...
    // Function to get the blog post by ID
    function get_blog_post($post_id, $blog_posts) {
        return isset($blog_posts[$post_id]) ? $blog_posts[$post_id] : null;
    }

    // Get post_id from URL
    $post_id = isset($_GET['post_id']) ? $_GET['post_id'] : 0;
    $post = get_blog_post($post_id, $blog_posts);
    ?>
